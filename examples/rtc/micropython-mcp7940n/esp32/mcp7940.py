class MCP7940:
    ...
    def init0(self):
        self._i2c.writeto_mem(MCP7940.ADDRESS, 0x07, bytes([0x10]))
        self._i2c.writeto_mem(MCP7940.ADDRESS, 0x08, bytes([0x45]))
    ...
    def alarm0_every_minute(self):
        ...
        self._i2c.writeto_mem(MCP7940.ADDRESS, 0x0A, bytes([0x40])) # BCD seconds each minute
